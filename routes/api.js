...
router.get('/meme', async (req, res, next) => {
	...
	if(!apikey) return res.json(loghandler.notparam)
       ...
       if(listkey.includes(apikey)){
       var image = "https://api.lolhuman.xyz/api/meme/memeindo?apikey=sayahafiz"
       fetch(encodeURI(`https://api.imgbb.com/1/upload?expiration=120&key=6346fb5fe9b50aa3eb40e3c2f04ad3c9&image=${image}&name=${randomTextNumber}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/pinterest-img', async (req, res, next) => {
        var apikey = req.query.apikey,
              text = req.query.text
    ...
    if(!text) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter text"})
       ...
       if(listkey.includes(apikey)){
       var image = "https://dapuhy-api.herokuapp.com/api/search/pinterest-image?query="+ text +"&apikey=sayahafiz"
       fetch(encodeURI(`https://api.imgbb.com/1/upload?expiration=120&key=6346fb5fe9b50aa3eb40e3c2f04ad3c9&image=${image}&name=${randomTextNumber}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
...
router.get('/gachacowok', async (req, res, next) => {
        var apikey = req.query.apikey
	...
	if(!apikey) return res.json(loghandler.notparam)
       ...
       if(listkey.includes(apikey)){
       var image = "https://dapuhy-api.herokuapp.com/api/search/pinterest-image?query=cowok aesthetic&apikey=sayahafiz"
       fetch(encodeURI(`https://api.imgbb.com/1/upload?expiration=120&key=6346fb5fe9b50aa3eb40e3c2f04ad3c9&image=${image}&name=${randomTextNumber}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
...
router.get('/darkjokes', async (req, res, next) => {
	...
	if(!apikey) return res.json(loghandler.notparam)
       ...
       if(listkey.includes(apikey)){
       var image = "https://api.lolhuman.xyz/api/meme/darkjoke?apikey=sayahafiz"
       fetch(encodeURI(`https://api.imgbb.com/1/upload?expiration=120&key=6346fb5fe9b50aa3eb40e3c2f04ad3c9&image=${image}&name=${randomTextNumber}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
...
router.get('/estetik', async (req, res, next) => {
	...
	if(!apikey) return res.json(loghandler.notparam)
       ...
       if(listkey.includes(apikey)){
       var image = "https://api.zeks.me/api/estetikpic?apikey=apivinz"
       fetch(encodeURI(`https://api.imgbb.com/1/upload?expiration=120&key=6346fb5fe9b50aa3eb40e3c2f04ad3c9&image=${image}&name=${randomTextNumber}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
